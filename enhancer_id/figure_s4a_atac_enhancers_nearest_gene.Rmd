...
options(knitr.figure_dir = "figure_s4a_atac_enhancers_nearest_gene")
...
# Figure S4a: ATAC enhancers nearest gene analysis
...
percents.df$peak_group %<>% factor(levels=rev(c("Differential", "No change")))

g <- ggplot(percents.df, aes(x=rank, y=percent_diff_exp, fill=peak_group)) +
     geom_bar(stat="identity", position="dodge") +
     scale_fill_manual("Enhancer group", values=c("Differential"="#840C03", "No change"="#808080")) +
